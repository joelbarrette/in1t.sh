...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        reboot_help: "unsupported via web terminal",
        cd_help: "change the current  directory",
        mv_help: "move or rename file",
        rm_help: "remove file or directory",
        ...
        reboot_message: "unsupported via web terminal, the system administrator has be notified of this attempt",
...
var main = (function () {
    ...
    Terminal.prototype.reboot = function () {
         this.type(configs.getInstance().reboot_message, this.unlock.bind(this));
    };
